...
parser.add_argument('--pretrain', type=str, default='imagenet')#pretrain
...
# 在 opts.py 的 add_argument 部分添加以下参数

# 蒸馏相关参数
group = parser.add_argument_group('Distillation Parameters')
group.add_argument('--distill', action='store_true', 
                   help='use distillation training')
group.add_argument('--temperature', type=float, default=3.0,
                   help='temperature for distillation')
group.add_argument('--feature_weight', type=float, default=0.3,
                   help='weight for feature distillation loss')
group.add_argument('--temporal_weight', type=float, default=0.3,
                   help='weight for temporal distillation loss')
group.add_argument('--freeze_backbone', action='store_true',
                   help='freeze backbone layers')
group.add_argument('--freeze_until', type=str, default='layer4',
                   choices=['none', 'conv1', 'layer1', 'layer2', 'layer3', 'layer4'],
                   help='freeze layers until')
group.add_argument('--train_fc', action='store_true',
                   help='train fc layers')
group.add_argument('--clip_model', type=str, default='openai/clip-vit-base-patch32',
