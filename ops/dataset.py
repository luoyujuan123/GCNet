...
class TSNDataSet(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if('something' in self.dataset): 
            ...
            # video_list = os.listdir(record.path)
            #video_path = '/media/hd0/datasets/ssv2/' + directory
            #video_list = decord.VideoReader(video_path)
            #video_list = os.listdir("/home/liujiayu/data/somethingV2/20bn-something-something-v2")
            ...
            try:
                ...
                if directory[-4:] != ".mp4":
                    video_path = directory#humbd51
                    #video_path = '/home/liujiayu/data/somethingV2/20bn-something-something-v2/' + directory#something
                    #video_path = '/home/lj/wanaihua/GCNet-all/GCNet/data/UCF-101/' + directory + '.avi'#ucf
                    #video_path = '/raid5/liujiayu/TDN-main/Dataset/kinetics-400/'+directory+'.mp4'
                    #video_path = directory#kintics
                    #video_path='/media/hd0/datasets/kinetics'+directory
